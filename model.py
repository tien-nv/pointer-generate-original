...
class Encoder(nn.Module):
    ...
    def forward(self, input, seq_lens):
        ...
        # print("Số chiều của embedding",embedded.shape)
        # print(embedded)
...
class Decoder(nn.Module):
    ...
    def forward(self, y_t_1, s_t_1, encoder_outputs, encoder_feature, enc_padding_mask,
        ...
        # print("Số chiều của output embedding",y_t_1_embd.shape)
        # print(y_t_1_embd)
        ...
        epsilon = 1e-10
        epsilon_mask = torch.ones_like(final_dist) * epsilon
        final_dist = final_dist+epsilon_mask
